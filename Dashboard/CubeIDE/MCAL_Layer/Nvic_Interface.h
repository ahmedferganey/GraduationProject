...
/* 
  * NVIC_uint8GetPendingIRQ - > Get the pending flag state    
  * i/p : Interrupt number (NVIC_IRQn_t) 0:59
  * o/p : (uint8) 0 or 1
*/
uint8   NVIC_uint8GetPendingIRQ (NVIC_IRQn_t copyIRQn);
...
/* 
  * NVIC_uint8GetActive - > Get the active flag state    
  * i/p : Interrupt number (NVIC_IRQn_t) 0:59
  * o/p : (uint8) 0 or 1
*/
uint8  NVIC_uint8GetActive (NVIC_IRQn_t copyIRQn);

/* 
  * NVIC_voidSetPriority - > Set periority for a specific external interrupt   
  * i/p : Interrupt number (NVIC_IRQn_t) 0:59  /  Interrupt periority (uint8) 0:15
*/
void NVIC_voidSetPriority (NVIC_IRQn_t copyIRQn, uint8 copy_uint8Priority);
