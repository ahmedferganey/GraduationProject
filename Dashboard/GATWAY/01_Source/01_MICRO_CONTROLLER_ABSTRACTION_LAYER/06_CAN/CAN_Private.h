...
typedef struct
{
    ...
    uint32 BTR;
    uint32  RESERVED0[88];
    CAN_TxMailBoxType_Def sTxMailBox[3];        //There are three TX Mailboxes and two RX Mailboxes
    CAN_FIFOMailBoxType_Def sFIFOMailBox[2];    //There are three TX Mailboxes and two RX Mailboxes
    uint32  RESERVED1[12];
    uint32 FMR;
    uint32 FM1R;
    uint32  RESERVED2;
